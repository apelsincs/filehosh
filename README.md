...
Для быстрого развертывания на VPS используйте автоматический скрипт:
...
Полное руководство по развертыванию на VPS смотрите в [DEPLOYMENT.md](DEPLOYMENT.md).
